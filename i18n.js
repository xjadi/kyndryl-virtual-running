...
const TRANSLATIONS = {
  en: {
    ...
    hero_sub: "Complete your distance, screenshot your result from any running app, and upload it here. Our Gemini reads your stats automatically. Compete with runners worldwide — no finish line, no excuses.",
  ...
  th: {
    ...
    hero_sub: "วิ่งให้ครบระยะ ถ่ายภาพหน้าจอผลการวิ่ง แล้วอัพโหลดที่นี่ gemini จะอ่านสถิติของคุณโดยอัตโนมัติ แข่งกับนักวิ่งทั่วโลก — ไม่มีข้อแม้",
