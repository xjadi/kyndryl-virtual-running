...
const TRANSLATIONS = {
  en: {
    ...
    review_body: "AI has extracted your run data and locked the fields. You may correct your runner name if needed. Verify all details are correct, then submit to the leaderboard.",
  ...
  th: {
    ...
    review_body: "AI ดึงข้อมูลการวิ่งแล้วล็อคฟิลด์ไว้ คุณสามารถแก้ไขชื่อนักวิ่งได้ ตรวจสอบข้อมูลให้ถูกต้องก่อนกดส่ง",
