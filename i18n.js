...
const TRANSLATIONS = {
  en: {
    ...
    disclaimer: "Disclaimer: The information and photos provided will be used solely for the purposes of the Running the Kyndryl Way 2026 activity. They will not be shared, distributed, or used for any other purpose without prior consent.",
    ...
    review_title: "✅ Please review before submitting",
    review_body: "AI has automatically extracted your run data and locked the fields.<br/>Please ensure your runner name matches your registration name (your runner name can still be edited).<br/>Please verify all details carefully, then submit your results to the leaderboard.",
  ...
  th: {
    ...
    disclaimer: "ข้อกำหนด: ข้อมูลและภาพถ่ายที่ให้ไว้จะถูกใช้เพื่อวัตถุประสงค์ของกิจกรรม Running the Kyndryl Way 2026 เท่านั้น โดยต่อมีการแบ่งปัน เผยแพร่ หรือใช้งานเพื่อวัตถุประสงค์อื่นโดยไม่ได้รับความยินยอมก่อน",
    ...
    review_title: "✅ โปรดตรวจสอบก่อนส่ง",
    review_body: "AI ได้ดึงข้อมูลการวิ่งของคุณโดยอัตโนมัติและล็อคฟิลด์ต่างๆ ไว้<br/>โปรดตรวจสอบให้แน่ใจว่าชื่อนักวิ่งของคุณตรงกับชื่อที่ลงทะเบียน (คุณยังสามารถแก้ไขชื่อนักวิ่งได้)<br/>โปรดตรวจสอบรายละเอียดทั้งหมดให้ถี่ถ้วน แล้วกดส่งผลเข้าสู่กระดานอันดับ",
